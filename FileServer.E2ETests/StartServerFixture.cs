...
public class StartServerFixture
{
    ...
    public void SetUpTestServer()
    {
        ...
        process.StartInfo.WorkingDirectory = Path.GetFullPath($"{ServerProjDir}/bin/e2etests/settings");
        ...
        WaitUntilServerStarted(serverOutput.ToString);
    }
